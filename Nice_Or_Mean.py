...
#
# Purpose: Creating my first mini game that 
#          Demonstrates how to pass varables
...
def describe_game(name):
    ...
    # then they are a new player and we need to get new name
...
def win(nice, mean, name):
    # Subsitute the {} with our variable values
